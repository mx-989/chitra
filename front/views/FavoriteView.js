...
class FavoriteView {
    ...
    setupStyles() {
        if (document.querySelector('#favorite-styles')) return;
        ...
        style.textContent = `
            ...
            .favorite-photo-item:hover {
                transform: translateY(-4px);
                box-shadow: 0 8px 24px rgba(0,0,0,0.3);
            }

            .favorite-photo-cover {
                position: relative;
                aspect-ratio: 1;
                overflow: hidden;
            }

            .favorite-photo-cover img {
                width: 100%;
                height: 100%;
                object-fit: cover;
            ...
            .favorite-photo-item:hover .favorite-photo-cover img {
            ...
            .favorite-photo-item:hover .photo-overlay {
                opacity: 1;
            }
